...
JFrame jf;
JButton b1,b2,b3;
JLabel l1,l2,l3,l4,l5,l6,lb,l7;
JTextField t1,t2;
JPasswordField p1;
Font f;
int cnt=0,cnt1=0;
...
jf.setLayout(null);
        l7=new JLabel("Hospital Management System");
        l7.setFont(new Font("Algerian",Font.PLAIN,30));
        l7.setForeground(Color.BLUE);
        l7.setBounds(100,50,500,40);
...
l2.setBounds(150,300,200,25);
jf.add(l2);

p1 = new JPasswordField(20);
p1.setBounds(250,300,200,25);
jf.add(p1);

b1 = new JButton("Login");
b1.setBounds(170,400,100,35);
jf.add(b1);
...
if((s.compareTo("ramya")==0)&&(s1.compareTo("admin")==0))
{
